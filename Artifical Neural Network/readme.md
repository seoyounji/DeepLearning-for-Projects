...
<img src="images/12.PNG" width="100px" height="30px" title="MSE" alt="MSE"></img><br/>

이제 나온 이 오차 E를 Backpropagation 하기만 하면 된다!     

Forward propagation을 통해 구해진 layer 0과 layer 1을 살펴보면 아래와 같다.    
<img src="images/13.PNG" width="200px" height="50px" title="layer0layer1" alt="layer0layer1"></img><br/>
...
<img src="images/14.PNG" width="100px" height="30px" title="Ew" alt="Ew"></img><br/>

먼저 첫번째 항부터 계산해보자. MSE에 따르면 E는 아래와 같이 나타낼 수 있었다.    
<img src="images/15.PNG" width="150px" height="30px" title="E" alt="E"></img><br/>

위 식을 a20에 대해 편미분해 첫번째 항을 구하면 아래와 같다.    
<img src="images/16.PNG" width="200px" height="50px" title="a20" alt="a20"></img><br/>

이 계산 결과로 전체 에러 E에 대해 a20이 0.37만큼 기여했다는 것을 알 수 있다.    
이런 식으로 두번째 항과 세번째 항도 계산해보면 아래와 같다.    
<img src="images/17.PNG" width="200px" height="50px" title="1" alt="1"></img><br/>
<img src="images/18.PNG" width="100px" height="30px" title="2" alt="2"></img><br/>

최종적으로 E에 w(1)10가 기여한 정도는 아래와 같다.    
<img src="images/19.PNG" width="150px" height="30px" title="3" alt="3"></img><br/>
...
<img src="images/20.PNG" width="200px" height="50px" title="new w110" alt="new w110"></img><br/>
